...
while not done:
    ...
    spt = (vcord[0][0]-20,vcord[0][1])
    ept = (vcord[0][0],vcord[0][1]+20)
    pygame.draw.line(screen, RED, spt,ept,1)
    spt = (vcord[1][0]-20,vcord[1][1])
    ept = (vcord[1][0],vcord[1][1]-20)
    pygame.draw.line(screen, RED, spt,ept,1)
    spt = (vcord[2][0]-20,vcord[2][1])
    ept = (vcord[2][0],vcord[2][1]+20)
    pygame.draw.line(screen, RED, spt,ept,1)
    spt = (vcord[3][0]-20,vcord[3][1])
    ept = (vcord[3][0],vcord[3][1]-20)
    pygame.draw.line(screen, RED, spt,ept,1)
    ...
    pygame.draw.line(screen,RED,(maxhcords[0][0],maxhcords[0][1]-20),(maxhcords[2**3-1][0],maxhcords[2**3-1][1]-20),1)
    pygame.draw.line(screen,RED,(maxhcords[0][0],maxhcords[0][1]+20),(maxhcords[2**3-1][0],maxhcords[2**3-1][1]+20),1)
