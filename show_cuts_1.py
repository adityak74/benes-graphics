...
pygame.display.set_caption("Cuts for Level 1 and 3 of Benes " + str(level))
...
while not done:
    ...
    pygame.draw.line(screen,RED,(maxhcords[0][0],maxhcords[0][1]-20),(maxhcords[2**3-1][0],maxhcords[2**3-1][1]-20),2)
    pygame.draw.line(screen,RED,(maxhcords[0][0],maxhcords[0][1]+20),(maxhcords[2**3-1][0],maxhcords[2**3-1][1]+20),2)
